...
def all_data():
    ...
    # Create dictionaries to store data for each table
    bronze_dict = {'Name': [], 'WBS_NO': [], 'House': [],'Email':[],'Phone Number':[],'ORB_NUMBER':[]}
    silver_dict = {'Name': [], 'WBS_NO': [], 'House': [],'Email':[],'Phone Number':[],'ORB_NUMBER':[]}
    gold_dict = {'Name': [], 'WBS_NO': [], 'House': [],'Email':[],'Phone Number':[],'ORB_NUMBER':[]}
    ...
    def display_table(category, data):
        ...
        # Insert data into the table
        for i in range(len(data['Name'])):
            table.insert(tk.END, f"{data['Name'][i]}\t\t{data['WBS_NO'][i]}\t\t{data['House'][i]}\t\t{data['Email'][i]}\t\t{data['Phone Number'][i]}\t\t{data['ORB_NUMBER'][i]}\n")
...
button_complete_parent_consent.pack(pady=50,padx=50)
